...
@section('body')
    ...
    <body style="height: 100%;margin-top: 100px;">
        <div
            ...
            <div class="d-xl-flex flex-column align-items-xl-center"><img src="assets/img/Current%20location-bro.png"
                    style="width: 300px;"></div>
            <div class="d-flex d-xl-flex flex-column align-items-center align-items-xl-center" style="margin-top: 50px;">
                <p style="width: 100%;text-align: center;font-weight: bold;">Ensure that location permissions are allowed</p>
